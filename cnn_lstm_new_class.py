...
data_test_org = load_data('data/GSU/Pocket/gsu_pocket.csv')
...
for user in users:
    ...
    model_path = 'model/base_model_all_users_new_label.h5'
    ...
    cnn_tl_results_file = 'result/results_cnn_lstm_new_class_15022022.csv'
    #cnn_tl_results_cm_base_file = 'result/results_cnn_lstm_new_class_cm_base_15022022.csv'
    cnn_tl_results_cm_new_file = 'result/results_cnn_lstm_new_class_cm_15022022.csv'
